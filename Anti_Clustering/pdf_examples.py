...
def cluster_voids_example_plots():
    ...
    minus_title = f'Negative Correlation'
    plot_sim(hist, bin_width, None, ax_sim=ax_minus, legend=False)
    ...
    plus_title = f'Positive Correlation'
    plot_sim(hist, bin_width, None, ax_sim=ax_plus, legend=False)
...
def plot_sim(hist, bin_width, title='Protons in Bin Distribution', ax_sim=None, legend=True):
    if ax_sim is None:
