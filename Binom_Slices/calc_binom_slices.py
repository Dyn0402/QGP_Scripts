...
def define_datasets(base_path):
    ...
    entry_vals = [
        ...
        ['anticlmulti_s01_a05', '_Sim_2source_Tests', ['resample', 'anticlmulti', 'spread01', 'amp05'],
         [], [], [0], [62], [8], all_divs],
        ['anticlflow_s05_a05', '_Sim_2source_Tests', ['resample', 'anticlflow', 'spread05', 'amp05'],
         [], [], [0], [62], [8], all_divs],
        ['anticlflow_s1_a05', '_Sim_2source_Tests', ['resample', 'anticlflow', 'spread1', 'amp05'],
         [], [], [0], [62], [8], all_divs],
        ['anticlflow_s08_a05', '_Sim_2source_Tests', ['resample', 'anticlflow', 'spread08', 'amp05'],
         [], [], [0], [62], [8], all_divs],
        ['anticlflow_s01_a05', '_Sim_2source_Tests', ['resample', 'anticlflow', 'spread01', 'amp05'],
         [], [], [0], [62], [8], all_divs],
    ]
