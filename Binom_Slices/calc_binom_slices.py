...
def init_pars():
    pars = {
        ...
        'csv_path': 'F:/Research/Results/Azimuth_Analysis/Binomial_Slice_Moments/binom_slice_stats_ampt_noprerot.csv',
...
def define_datasets(base_path):
    ...
    entry_vals = [
        ...
        #  all_cents, all_divs],
        ['ampt_new_coal_resample_def_noprerot', '_Ampt_New_Coal', ['default', 'resample', 'noprerotate'],
