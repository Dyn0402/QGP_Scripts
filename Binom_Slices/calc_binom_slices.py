...
def define_datasets(base_path):
    ...
    entry_vals = [
        ...
        ['anticlflow_s1_a05', '_Sim_2source_Tests', ['resample', 'anticlflow', 'Eff', 'spread1', 'amp05'],
         [], [], [0], [62], [8], all_divs],
        ['anticlflow_s08_a05', '_Sim_2source_Tests', ['resample', 'anticlflow', 'Eff', 'spread08', 'amp05'],
         [], [], [0], [62], [8], all_divs],
        ['anticlflow_s05_a05', '_Sim_2source_Tests', ['resample', 'anticlflow', 'Eff', 'spread05', 'amp05'],
         [], [], [0], [62], [8], all_divs],
        ['anticlflow_s01_a05', '_Sim_2source_Tests', ['resample', 'anticlflow', 'Eff', 'spread01', 'amp05'],
         [], [], [0], [62], [8], all_divs],
        ...
        ['anticlflow_eff_s1_a05_v207', '_Sim_2source_Tests', ['resample', 'anticlflow', 'spread1', 'amp05', 'Eff'],
         [], [], [0], [62], [8], all_divs],
    ]
