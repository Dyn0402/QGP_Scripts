...
def main():
    ...
    # ampt_new_coal_info = ('default_resample', 'Ampt_rapid05_resample_norotate_0', 'Data_Ampt', 'Data_Ampt_Mix',
    #                       'ampt_resample_def')
    # chi2_test_all(ampt_new_coal_info, 'F:/Research/Results/Azimuth_Analysis/ampt_new_coal_chi2_all_dist_bs.csv')
    # sum_chi2('F:/Research/Results/Azimuth_Analysis/ampt_new_coal_chi2_all_dist_bs.csv',
